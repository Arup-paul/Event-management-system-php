...
<div id="main-content" class="main-content">
		<div class="page-title">
				...
				<h1><i class="fa fa-plus"></i> Add New Footer Link </h1>
			...
			<?php
				if (isset($_GET['edit'])) {
					...
					<form action="" method="POST" enctype="multipart/form-data" class="col-lg-6">
        				<div class="form-group col-lg-12 ">
        					<input type="text" name="pname" class=" form-control " placeholder="Link Name/Title">
        				</div>
        				<div class="form-group col-lg-12 ">
        					<input type="text" name="purl" class=" form-control " placeholder="http://domain.com (Link URL)">
        				</div>
            				...
            				<div class="form-group col-lg-12 col-sm-12 col-md-12 col-xs-12">
            				      <button type="submit" name="service_insert" class="btn btn-md btn-primary" value="Insert Link"><i class="fa fa-chain"></i> Add Link</button>
            				</div>
            			</form>
					';
				}
