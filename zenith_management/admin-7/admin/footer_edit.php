			...
			<?php
				if(isset($_GET['id'])){
						...
						while($edit_row=mysql_fetch_array($run_edit)){
							...
							$id          =$edit_row['id'];
							$caption    =$edit_row['caption'];
							$image       =$edit_row['image'];

							echo' 
									<h1>GELLERY EDIT FORM</h1>
								<form action="" method="post">
											...
											<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
												<input type="text" class="form-control caption_text" value="'.$caption.'" name="caption" >
											</div>
				...
				if(isset($_POST['update'])){
					...
					$new_insert ="UPDATE blog SET caption ='$blog_name', image='$image' WHERE id='$new_id'";
